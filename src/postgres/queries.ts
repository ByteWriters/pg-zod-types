...
export const enums = `
SELECT t.typname as "pg_type", n.nspname schema_name, string_agg(e.enumlabel, ';') AS values
  FROM pg_type t
...
export const types = `
SELECT udt_schema schema_name, udt_name "pg_type", array_agg(json_build_object(
  'name', attribute_name,
